<h1 align="center">Desafio 15 - Pricing table</h1>

<p align="center">Essa é minha solução para o desafio Pricing table do projeto <a href="https://www.rocketseat.com.br/boracodar">#boraCodar</a> da RocketSeat.</p>

<h2 align="center">
  <a href="https://15-pricing-table.netlify.app/">🔹 Acesse o site através deste link. 🔹</a>
</h2>

## :sparkles: O desafio

O desafio consiste em desenvolver uma pagina com uma tabela preços de serviços, era possível escolher qual tecnologia utilizar, então para esse desafio acabei utilizando React Js e Vite.
...
cd bora-codar/15-pricing-table
```
